...
## Paper Information
- **ArXiv ID**: 2606.13295v1
- **URL**: https://arxiv.org/abs/2606.13295v1
- **Published**: 2026-06-11T12:48:30Z
- **Categories**: stat.ML, cs.LG, stat.ME

## Authors
- Simultaneous Latent Budget Trees for Stratified Classification Cristian Buoncompagni
- Stefano Pellegrino
- Giulia Vannucci
- Roberta Siciliano
...
## Links
- [ArXiv Paper](https://arxiv.org/abs/2606.13295v1)
- [PDF](https://arxiv.org/pdf/2606.13295v1.pdf)
